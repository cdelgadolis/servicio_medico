...
$this->pageTitle=Yii::app()->name . ' - Centro Simón Bolívar';
$this->breadcrumbs=array(
	'Sede'=>array('index'), 'Centro Simón Bolívar',
);
?>
<div class="form">
...
<h4 class="titulo">Torre Centro Simón Bolívar</h4>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="<?php echo Yii::app()->request->baseUrl.'/images/sedes/TSB/0.jpg'?>" alt="" class= "tales">
    </div>

    <div class="item">
      <img src="<?= Yii::app()->getBaseUrl(true) . '/images/sedes/TSB/1.jpg' ?>" alt="" class= "tales">
    </div>

    <div class="item">
      <img src="<?= Yii::app()->getBaseUrl(true) . '/images/sedes/TSB/2.jpg' ?>" alt="" class= "tales">
    </div>

    <div class="item">
      <img src="<?= Yii::app()->getBaseUrl(true) . '/images/sedes/TSB/3.jpg' ?>" alt="" class= "tales">
    </div>

   <div class="item">
      <img src="<?= Yii::app()->getBaseUrl(true) . '/images/sedes/TSB/4.jpg' ?>" alt="" class= "tales">
  </div>
  </div>
