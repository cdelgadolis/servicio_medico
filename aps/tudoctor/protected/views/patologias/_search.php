<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldGroup($model,'id_tipo_patologia',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

		<?php echo $form->textFieldGroup($model,'patologia',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>100)))); ?>
