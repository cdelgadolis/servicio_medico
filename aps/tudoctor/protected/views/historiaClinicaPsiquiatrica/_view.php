<div class="view">
		...
		<b><?php echo CHtml::encode($data->getAttributeLabel('id_hc_psiquiatrica')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_hc_psiquiatrica),array('view','id'=>$data->id_hc_psiquiatrica)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('antecedentes_familiares')); ?>:</b>
	<?php echo CHtml::encode($data->antecedentes_familiares); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('tabaco')); ?>:</b>
	<?php echo CHtml::encode($data->tabaco); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('examen_mental')); ?>:</b>
	<?php echo CHtml::encode($data->examen_mental); ?>
	<br />
