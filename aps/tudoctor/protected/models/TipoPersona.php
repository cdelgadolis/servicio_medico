 ...
 *
 * The followings are the available columns in table 'tipo_persona':
 ...
 */
class TipoPersona extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('tipo_persona', 'length', 'max'=>100),
			array('fecha_creacion, status, fecha_actualizacion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_tipo_persona, tipo_persona, fecha_creacion, usuario_actualizacion, usuario_creacion, status, fecha_actualizacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'pacientes' => array(self::HAS_MANY, 'Paciente', 'tipo_persona'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->order = 'id_tipo_persona DESC';
	 ...
	 * @return TipoPersona the static model class
	 */
