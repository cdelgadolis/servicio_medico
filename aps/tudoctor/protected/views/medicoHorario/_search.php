<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldGroup($model,'id_medico_horario',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

		<?php echo $form->textFieldGroup($model,'medico',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

		<?php echo $form->textFieldGroup($model,'dia',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

		<?php echo $form->textFieldGroup($model,'hora_entrada',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
