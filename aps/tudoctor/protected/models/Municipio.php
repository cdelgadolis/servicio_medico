...
class Municipio extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('estado, nombre', 'required'),
			array('estado, fk_usuario_creacion, fk_usuario_actualizacion', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>100),
			array('estatus, fecha_creacion, fecha_actualizacion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_municipio, estado, nombre, estatus, fecha_creacion, fecha_actualizacion, fk_usuario_creacion, fk_usuario_actualizacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->order = 'id_municipio DESC';
