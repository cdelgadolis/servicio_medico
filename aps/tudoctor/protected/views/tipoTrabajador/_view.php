<div class="view">
		...
		<b><?php echo CHtml::encode($data->getAttributeLabel('id_tipo_trabajador')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_tipo_trabajador),array('view','id'=>$data->id_tipo_trabajador)); ?>
	<br />
