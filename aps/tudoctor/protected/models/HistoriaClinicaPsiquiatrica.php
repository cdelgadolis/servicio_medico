...
/**
 * This is the model class for table "historia_clinica_psiquiatrica".
 *
 * The followings are the available columns in table 'historia_clinica_psiquiatrica':
 * @property integer $id_hc_psiquiatrica
 ...
 */
class HistoriaClinicaPsiquiatrica extends CActiveRecord
{
	/**
	...
	{
		return 'historia_clinica_psiquiatrica';
	}
	...
	public function search()
	{
		...
		$criteria->order = 'id_hc_psiquiatrica DESC';

		$criteria->compare('id_hc_psiquiatrica',$this->id_hc_psiquiatrica);
	 ...
	 * @return HistoriaClinicaPsiquiatrica the static model class
	 */
